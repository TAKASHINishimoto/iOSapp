...
class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
    ...
    private var alertViewWidth: CGFloat = 290.0
    ...
    private var innerContentWidth: CGFloat = 200.0
    ...
    private var titleLabel = UIImageView(frame: CGRectMake(45,20,200,55))
    ...
    private var buttonMargin: CGFloat = 20.0
    ...
    private var buttonCornerRadius: CGFloat = 6.0
...
//            titleLabel.backgroundColor = UIColor(patternImage: UIImage(named: "helper-alert")!)
//            titleLabel.frame = CGRectMake(0, textAreaPositionY, innerContentWidth, titleLabel.frame.height)
            titleLabel.image = UIImage(named: "helper-alert")
